...
public class AddressServiceImpl implements AddressService{
    ...
    public ShippingAddrDto saveAddress(ShippingAddrDto addrDto, Integer customerId) {
        ...
        ShippingAddressEntity addressEntity = ShippingAddrMapper.convertToEntity(addrDto);
    ...
    public List<ShippingAddrDto> getCustomerAddresses(Integer customerId) {
        List<ShippingAddressEntity> addressEntityList
                = addressRepository.findByCustomerCustomerIdAndDeleteSw(customerId, "N");
        return addressEntityList.stream().map(ShippingAddrMapper::convertToDto).toList();
    }
